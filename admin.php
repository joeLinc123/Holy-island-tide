...
<html lang="<?php echo $language; ?>">
  ...
  <body>
    ...
    <?php elseif ($language == 'en'): ?>
      ...
      <p class="text"><strong><a href="http://localhost:8888/login/NotifOne.php">One off notification</a></strong></p>
      <p class="text"><strong><a href="http://localhost:8888/phpMyAdmin5/index.php?route=/sql&server=1&db=mysql&table=proc&pos=0">Use PHP Admin</a></strong></p>
      <p class="text"><strong><a href="http://localhost:8888/login/repeatNotification.php">Start notifications</a></strong></p>
      <p class="text">
