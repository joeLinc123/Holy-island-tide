#Used to send acknowledgement to user - using twitter dm functionality from API
...
twitter.send_direct_message(event={'type':'message_create','message_create':{'target':{'recipient_id':twitterID},'message_data':{'text':'Holy Island Crossing: Please Accept messages from Holy Island if not already done so to receive notifications!'}}})
